...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=viktoriousss&repo=new-tanzu-java-web-app",
  "buildTool" : "maven",
  "includeBuildToolWrapper" : true,
  "javaVersion" : "17",
  "nativeBuild" : false,
  "projectName" : "new-tanzu-java-web-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->new-tanzu-java-web-a...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: new-tanzu-java-web...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=viktoriousss&repo=new-tanzu-java-web-app'
